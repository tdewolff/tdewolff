...
- [log](https://github.com/tdewolff/log): Package-wide logging to console/file/journald including levels, colours, datetime and source file & line number.
- [mail](https://github.com/tdewolff/mail): Mail related utilities, including parsing DMARC and SMTP TLS reports and the milter protocol.
  - [cmd/milter](https://github.com/tdewolff/mail/tree/master/cmd/milter): A mail filter to prevent e-mail spoofing, use Sender Rewriting Scheme (SRS), and parse SMTP TLS/DMARC reports.
